    ...
    <body class="by">
        ...
        <table >
            ...
            <tr>
                ...
                <p style="background:#f03d3d; color:white;">Melissa Raineri Godoy</p>
            </td>
                <td >
                    <ul>
                        <li ><a href ="cascão.php">Cascão</a></li>
            ...
            <tr>
                ...
                <img src="../img/jose.jpg" alt="aqui temos a imagem do José Guilherme">
                    <p style="background:#f03d3d; color:white;">José Guilherme Guimarães Campos</p></td>
                <td><ul>
            ...
            <tr>
                ...
                <p  style="background:#f03d3d; color:white;" >Gilberto</p>
            ...
            <tr>
                ...
                <p  style="background:#f03d3d; color:white;" >Yasmin</p>
            </td>
