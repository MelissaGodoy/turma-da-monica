...
<html lang="pt-br">
    ...
    <body>
        ...
        <article>
            ...
            <section>
                ...
                <p class="texto-direito">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam velit metus, 
                    ...
                    condimentum iaculis. Mauris laoreet, metus eget pharetra luctus, ipsum lacus 
                    placerat leo, quis dapibus leo tellus ac leo. Sed pulvinar porttitor nisl vel 
                    sollicitudin. Fusce in semper nisl. Pellentesque at ornare diam, semper commodo 
        ...
        <footer class="final">
            <nav>
                <ul class="footer">
                    <li><a href="historia-parte1.php">Voltar</a></a></li>
                    <li><a href="historia-parte2.php">Avançar</a></a></li>  
                </ul>
            </nav>
        </footer>
    </body>
